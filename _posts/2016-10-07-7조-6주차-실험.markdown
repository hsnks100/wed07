...
{tap} - FCLK : CPU 에서 사용되는 Clock.

{tap} - HCLK : AHB 버스에 사용되는 Clock 으로 memroy controller, interrupt controller 등에 사용된다. 

{tap} - PCLK : APB 버스에 사용되는 Clock 으로 GPIO, UART, SPI 등에 사용된다. 
